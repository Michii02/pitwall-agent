...
test('live lap payload exposes bounded opponent facts without changing player fields', () => {
  const packet: ParseResult = {
    ...
    packet: {
      ...
      resultStatus: 2, lapDistance: 1_000,
      grid: [
        { vehicleIndex: 7, lastLapMs: 89_500, currentLapMs: 19_000, sector1Ms: 29_900, sector2Ms: 0, carPosition: 3, lapNumber: 8, pitStatus: 0, numPitStops: 1, lapInvalid: false, driverStatus: 4, resultStatus: 2, gridPosition: 2, lapDistance: 1_100, totalDistance: 40_000, gapAheadMs: 400, gapToLeaderMs: 4_158 },
        { vehicleIndex: 3, lastLapMs: 90_000, currentLapMs: 20_000, sector1Ms: 30_000, sector2Ms: 0, carPosition: 4, lapNumber: 8, pitStatus: 0, numPitStops: 1, lapInvalid: false, driverStatus: 4, resultStatus: 2, gridPosition: 6, lapDistance: 1_000, totalDistance: 39_900, gapAheadMs: 842, gapToLeaderMs: 5_000 },
        { vehicleIndex: 9, lastLapMs: 90_100, currentLapMs: 20_500, sector1Ms: 30_200, sector2Ms: 0, carPosition: 5, lapNumber: 8, pitStatus: 0, numPitStops: 1, lapInvalid: false, driverStatus: 4, resultStatus: 2, gridPosition: 7, lapDistance: 900, totalDistance: 39_800, gapAheadMs: 1_305, gapToLeaderMs: 6_305 },
      ],
    },
  }
  ...
  assert.equal('currentLapMs' in message.data.grid[0], false)
...
test('live status and damage payloads carry deterministic engineer fields', () => {
  const status = toLegacyMessage({
    ...
    packet: { kind: 'status', fuelInTank: 18, fuelMix: 0, visualTyreCompound: 17, actualTyreCompound: 12, tyresAgeLaps: 6, ersStoreEnergy: 3_000_000, ersDeployMode: 2, ersDeployedThisLap: 0, ersHarvestedThisLap: 0, vehicleFiaFlags: 0 },
  }, true, 123) as any
